      ...
      <section id="fitur" style={{ padding: "96px 16px", background: t.sectionAlt, transition: "background 0.3s" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "24px" }}>
            <FeatureCard t={t} icon={<Users style={{ width: "24px", height: "24px", color: "#2563EB" }} />} title="Manajemen Pedagang" description="Kelola data pedagang secara terpusat dengan verifikasi identitas dan rekam jejak digital yang lengkap." onClick={() => navigate("/login?redirect=/admin/traders")} />
            <FeatureCard t={t} icon={<Receipt style={{ width: "24px", height: "24px", color: "#F59E0B" }} />} title="Tagihan Digital" description="Penagihan otomatis dan pelacakan pembayaran retribusi secara real-time mengurangi tunggakan." onClick={() => navigate("/login?redirect=/admin/billing")} />
            <FeatureCard t={t} icon={<MapIcon style={{ width: "24px", height: "24px", color: "#059669" }} />} title="Peta Kios GIS" description="Visualisasi denah pasar interaktif untuk pemantauan okupansi dan zonasi area pedagang." onClick={() => navigate("/login?redirect=/admin/grid")} />
